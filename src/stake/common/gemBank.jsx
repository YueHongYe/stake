...
import {GemBankClient, isKp, WhitelistType} from '@gemworks/gem-farm-ts';
...
export class GemBank extends GemBankClient {
    constructor(conn, wallet, idl) {
        const programId = "5zz9sqvDCCQvVZUDV759grwPezRV6v1XwqZGqvGZZ7Yc";
    ...
    async withdrawGemWalletInstructions(
        bank,
        vault,
        gemAmount,
        gemMint,
        ...
        return this.bankProgram.instruction.withdrawGem(
            vaultAuthBump,
            gemBoxBump,
            GDRBump,
            gemRarityBump,
